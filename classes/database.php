<?php
	...
	fetch_single_data($table,$field,$wheres = array(),$orders = array())
	fetch_select_data($table,$id,$field,$wheres = array(),$orders = array(),$limit = "",$startwithnone = false)
    ...
    **************************************************************************/
    ...
    class Database {
		...
		public function __construct(){	
			$this->lines = file($_SERVER["DOCUMENT_ROOT"]."/db_config_hrd_proj.txt");
