<?php
	...
	include_once "window_boxs/candidate_bpjs_kesehatan.php";
...
?>
	...
	<?=$f->input("filter","Filter","type='button' data-toggle='modal' data-target='#candidate_bpjs_kesehatan'", "btn btn-success");?>
