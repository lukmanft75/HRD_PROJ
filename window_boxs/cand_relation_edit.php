...
<body>	
	<div class="modal-body" id="Add">
		<?php
			$candidate_relations	= $db->fetch_all_data("candidate_relations",[],"id = '".$_GET["data_id"]."'")[0];
			$candidate_id	= $_GET["candidate_id"];
			$candidate_name = $db->fetch_single_data("candidates","name",array("id"=>$candidate_id));

			if(isset($_POST["saving_new"])){
				$db->addtable("candidate_relations");	$db->where("id",$_GET["data_id"]);
		...
		<div class="login mx-auto mw-100">
			<h5 class="text-center">Candidate Relation - Edit</h5>
							...
							<?=$f->start("","POST","","enctype='multipart/form-data'");?>
								<div class="row wls-contact-mid">
									...
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										...
										<?=$f->select("relation_id",$db->fetch_select_data("relations","id","name",[],[],"",true),@$candidate_relations["relation_id"],"","select_form");?>
									</div>
								</div>
								<div class="row wls-contact-mid">
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										<font style="color:#1a75ff;font-style:italic;">Full Name</font>
										<?=$f->input("fullname",@$candidate_relations["fullname"],"required","form-control");?>
									</div>
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										<font style="color:#1a75ff;font-style:italic;">Division</font>
										<?=$f->input("division",@$candidate_relations["division"],"t","form-control");?>
									</div>
								</div>
								<div class="row wls-contact-mid">
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										<font style="color:#1a75ff;font-style:italic;">Location</font>
										<?=$f->input("location",@$candidate_relations["location"],"","form-control");?>
									</div>
								</div>
