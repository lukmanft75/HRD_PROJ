...
<body>	
	<div class="modal-body" id="Add">
		...
		<div class="login mx-auto mw-100">
			<h5 class="text-center">Candidate Work Experiences - Add</h5>
							...
							<?=$f->start("","POST","","enctype='multipart/form-data'");?>
								<div class="row wls-contact-mid">
									...
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										...
										<?=$f->input("company_name",@$_POST["company_name"],"required","form-control");?>
									</div>
								</div>
								<div class="row wls-contact-mid">
									<div class="col-md-6 col-sm-6 form-group contact-forms">
								...
								<div class="form-group contact-forms">
									...
									<?=$f->textarea("tasks",@$_POST["tasks"]," rows='3'","form-control");?>
								</div>
								<div class="row wls-contact-mid">
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										<font style="color:#1a75ff;font-style:italic;">Join At</font>
										<?=$f->input("join_at",@$_POST["join_at"],"type='date'","form-control");?>
									</div>
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										<font style="color:#1a75ff;font-style:italic;">Last At</font>
										<?=$f->input("last_at",@$_POST["last_at"],"type='date'","form-control");?>
									</div>
								</div>
								<div class="form-group contact-forms">
									<font style="color:#1a75ff;font-style:italic;">Leaving Reason</font>
									<?=$f->textarea("leaving_reason",@$_POST["leaving_reason"]," rows='3'","form-control");?>
								</div>
