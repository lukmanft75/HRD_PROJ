...
<body>			
	<?php
		...
		$employee_work_experiences = $db->fetch_data(true);
		
		if($_GET["deleting"]){
			$db->addtable("employee_work_experiences");	$db->where("id",$_GET["deleting"]);
			$deleting = $db->delete_();
	...
	<div class="modal-body" id="List">
		<div class="login mx-auto mw-100">
			<h5 class="text-center">Employee Work Experiences</h5>
			...
			<div class="table_list">
				<div style="overflow-x:auto;">
					<?=$t->start("","","data_content");?>
						...
						<?php 
							$i=0;
							foreach($employee_work_experiences as $no => $data){
								$i++;
