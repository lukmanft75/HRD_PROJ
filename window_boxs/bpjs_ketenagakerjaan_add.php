	...
	<div class="modal-body" id="Add">
		<?php
			...
			if(isset($_POST["saving_new"])){
				$db->addtable("bpjs");
				$db->addfield("bpjs_type");			$db->addvalue("2");
		...
		<div class="login mx-auto mw-100">
			<h5 class="text-center">BPJS Ketenagakerjaan - Add</h5>
							...
							<?=$f->start("","POST","","enctype='multipart/form-data'");?>
								...
								<div class="row wls-contact-mid">
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										...
										<?=$f->input("mothers_name",@$_POST["mothers_name"],"","form-control");?>
									</div>
									<div class="col-md-6 col-sm-6 form-group contact-forms">
								...
								<div class="row wls-contact-mid">
									...
									<div class="col-md-6 col-sm-6 form-group contact-forms">
										<font style="color:#1a75ff;font-style:italic;">Softcopy KJP</font>
