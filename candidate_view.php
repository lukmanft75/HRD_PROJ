								...
								<td colspan="6" width="31.2%" align="center" style="padding:15 0 0 0" valign="top">
									<table class="table_cv" width="100%">
										...
										<tr>
											...
											<td colspan="4" width="66.8%" align="center"><?=$db->fetch_single_data("bpjs","bpjs_id",["employee_id"=>$candidate["id"],"bpjs_type" => '2',"pisa" => "peserta"]);?></td>
										</tr>
										<tr>
											<td colspan="2" width="33.2%" align="center" nowrap>BPJS Kesehatan No.</td>
											<td colspan="4" width="66.8%" align="center"><?=$db->fetch_single_data("bpjs","bpjs_id",["employee_id"=>$candidate["id"],"bpjs_type" => '1',"pisa" => "peserta"]);?></td>
										</tr>
									</table>
								</td>
								<td colspan="1" width="5.2%" align="left" style="padding:15 0 0 0"></td>
